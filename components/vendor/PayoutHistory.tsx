...
import { DollarSign, TrendingUp, Clock, CheckCircle, ChevronLeft, ChevronRight } from 'lucide-react';
          ...
          {payoutsPagination.totalPages > 1 && (
            <div className="flex items-center justify-between mt-4">
              <p className="text-sm text-muted-foreground">
                ...
                {Math.min(payoutsPagination.page * payoutsPagination.perPage, payoutsPagination.total)} of{' '}
